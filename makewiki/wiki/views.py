...
class PageList(ListView):
    ...
    def get(self, request):
        ...
        print("this is the obj:", self.model.objects.all())
        wiki_list = self.model.objects.all()
        return render(request, "list.html", {"page": wiki_list})
...
class PageDetailView(DetailView):
    ...
    def get(self, request, slug):
        ...
        return render(request, 'page.html', {"page": obj})
    #
    # def post(self, request, slug):
    #    return render(request, 'bootstrap_display.html', slug)
